oS.Init(
	{
		PName: [oSunShroom, oPuffShroom, oPeashooter, oWallNut, oCherryBomb, oGhostShroom],
		ZName: [oZombie, oZombie2],
		PicArr: (function () {
